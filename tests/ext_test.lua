...
table.insert(steps, function()
  ...
  log("set", reaper.PhaseRot_SetTake(state.take, 78, 78, 0, 0, 0, 1))
  reaper.Undo_EndBlock("phaserot set", -1)
  local ok2, al, ar, ad, sm, by = reaper.PhaseRot_GetTake(state.take, 0, 0, 0, 0, 0, 0)
...
table.insert(steps, function()
  ...
  wait_then(0.6, function()
    ...
    local ok2 = reaper.PhaseRot_GetTake(state.take, 0, 0, 0, 0, 0, 0)
    ...
    wait_then(0.6, function()
      local ok3 = reaper.PhaseRot_GetTake(state.take, 0, 0, 0, 0, 0, 0)
...
table.insert(steps, function()
  ...
  wait_then(0.4, function()
    ...
    if tk2 then
      local ok2, al = reaper.PhaseRot_GetTake(tk2, 0, 0, 0, 0, 0, 0)
...
table.insert(steps, function()
  ...
  wait_then(1.0, function()
    ...
    if tk then
      local ok2, al = reaper.PhaseRot_GetTake(tk, 0, 0, 0, 0, 0, 0)
...
table.insert(steps, function()
  -- bypass + clear
  reaper.PhaseRot_SetTake(state.take, 78, 78, 0, 0, 1, 1)
...
table.insert(steps, function()
  ...
  local t0 = reaper.time_precise()
  reaper.PhaseRot_SetTake(tk, 0, 0, 1, 0, 0, 1)
  ...
  reaper.PhaseRot_SetTake(tk, 78, 78, 0, 0, 0, 1)
  ...
  reaper.PhaseRot_SetTake(tk2, 30, -45, 0, 0, 0, 0)
